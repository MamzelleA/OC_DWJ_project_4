...
?>
	<div class="col-sm-12 border-bottom border-left border-1 border-light my-3">
		<a class="px-3" data-toggle="collapse" role="button" href="#num-<?= $chap['num_chap'] ?>" aria-expanded="false" aria-controls="author-resume" title="cliquez pour lire un extrait">
